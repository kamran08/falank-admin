        ...
        data() {
            ...
            methods: {
                showEdit(index) {
                    ...
                    async removeItem() {
                        const res = await this.callApi('delete', '/app/flankSetting', {
                            id: this.removeId
                        })
                        if (res.status == 200) {
                    ...
                    async Update() {
                        ...
                        const response = await this.callApi('put', '/app/flankSetting', this.updateValue);
                    ...
                    async addItem() {
                        ...
                        const response = await this.callApi('post', '/app/flankSetting', this.form_data)
                        if (response.status === 200) {
            ...
            async created() {
                const res = await this.callApi('get', '/app/flankSetting')
                if (res.status == 200) {
